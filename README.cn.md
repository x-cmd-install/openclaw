...
![openclaw](https://repo.x-cmd.io/openclaw.svg?lang=zh)
...
合计: **10,728,147** 行代码（覆盖前 5 种语言、共 **37656** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| TypeScript | 9,657,513 | 199,750 | 654,780 | 35189 |
| Swift | 387,961 | 7,118 | 37,764 | 1302 |
| Kotlin | 218,902 | 3,902 | 19,474 | 536 |
| JavaScript | 111,100 | 3,688 | 5,675 | 487 |
| Css | 65,830 | 2,767 | 10,937 | 142 |
...
- **Star**: 389,811 · **Fork**: 81,934 · **开放 issue**: 53,710 · **贡献者**: 3,119

## 累计统计

- **发布数**: 243 · **已合并 PR**: 40598 · **开放 PR**: 2727 · **已关闭 issue**: 49029 · **开放 issue**: 4681 · **提交数**: 94953

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-17 | 9 | 14238 | 1838 | 4015 | 2326 | 14849 |
| last60d | 2026-07-18 | 18 | 22461 | 2437 | 6555 | 3083 | 25811 |
| 90d | 2026-06-18 | 33 | 29149 | 2603 | 10071 | 3504 | 38119 |
| last180d | 2026-03-20 | 100 | 36906 | 2724 | 28344 | 4269 | 78382 |
| 360d | 2025-09-21 | 100 | 40577 | 2727 | 49029 | 4681 | 101728 |
| last720d | 2024-09-26 | 100 | 40577 | 2727 | 49029 | 4681 | 94953 |
...
openclaw 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `openclaw` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/openclaw.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260916.yml` · 2026-09-16T05:18:38Z._
